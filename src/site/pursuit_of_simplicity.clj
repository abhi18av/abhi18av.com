      ...
      [:div {:class "wrapper-large"}
       [:div {:class "post"}
        [:nav {:class "nav"}
         [:ul {:class "list"}
          [:li {:class "item"}
           [:a {:class "link", :href "https://abhi18av.com/"} "Home"]" "]
          [:li {:class "item"}
           [:a {:class "link", :href "https://abhi18av.com/blog"} "Blog"]" "]
          [:li {:class "item"}
           [:a {:class "link", :href "https://abhi18av.com/projects"} "Projects"]" "]
          [:li {:class "item"}
        ...
        [:span {:class "date"}
         ...
         #_[:a {:class "item", :href "https://abhi18av.com/tags/#computation"} "Computation"]]
